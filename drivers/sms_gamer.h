/*
 * sms_gamer.h: defines/macros protocol for SMS Gamer UPSes
 *
 * Based on sms_ser.h by Alex W. Baule <alexwbaule@gmail.com>
...
#ifndef NUT_SMS_GAMER_H_SEEN
#define NUT_SMS_GAMER_H_SEEN 1
...
typedef struct {
    ...
    /* MODIFICAÇÃO: Adicionado campo para tensão real da bateria */
    float batteryVoltage;    /* battery.voltage - TENSÃO REAL lida do UPS (bytes 11-12) */
    
    /* MODIFICAÇÃO: batterylevel agora é calculado a partir da tensão, não lido diretamente */
    float batterylevel;      /* battery.charge - CALCULADO a partir de batteryVoltage para LiFePO4 */
